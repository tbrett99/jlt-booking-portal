                              ...
                              <div className="mt-1.5 rounded-lg border border-amber-300 bg-amber-50 px-3 py-2 flex items-start gap-2">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="mt-1 space-y-1">
                                    {matchingPreferred.map((pp) => (
                                      <div key={pp.id}>
                                        <p className="text-[10px] font-semibold text-amber-800">{pp.name}</p>
                                        {(pp as any).preferredPartnerNote && (
                                          <p className="text-[10px] text-amber-700">{(pp as any).preferredPartnerNote}</p>
                                        )}
                                      </div>
                                    ))}
                                  </div>
