...
export default function MyHolidayShowcases() {
  ...
  const submitEdit = trpc.consumerSite.showcases.submitEdit.useMutation({
    onSuccess: () => {
      toast.success("Your Holiday Showcase changes are now waiting for JLT review.");
