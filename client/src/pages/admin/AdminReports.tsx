...
export default function AdminReports() {
  ...
  const downloadCSV = () => {
    ...
    const headers = ["ID", "Client Name", "Agent", "Booked Date", "Departure Date", "Destination", "Passengers", "Nights", "Topdog Ref", "PTS Ref", "Stage", "Expected Commission", "Reimbursements", "Created At"];
