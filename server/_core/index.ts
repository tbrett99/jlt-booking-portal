    ...
    <p style="margin:0;color:#9ca3af;font-size:12px;text-align:center;">JLT Group Booking Portal — automated suspension alert</p>
              ...
              if (agentEmail) {
                ...
                const failureSubject = isSuspended
                  ? `\u26a0\ufe0f Portal Access Suspended \u2014 Membership Payment Failed (3rd Attempt)`
                  : `Action Required: Membership Payment ${event.action === "charged_back" ? "Charged Back" : "Failed"}`;
                const failureHtml = isSuspended
