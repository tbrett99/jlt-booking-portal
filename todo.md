...
- [x] Add an immutable booking-level audit record for manual commission completion and key-supplier declarations, visible in the admin booking view and Commission Management: claim submission now writes a separate internal immutable audit note and the admin booking detail displays the stored completion and supplier declarations with timestamps; focused regression, TypeScript, and production build pass
