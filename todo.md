...
- [x] Add Won and Waitlisted to CRM prospects stage enum and run migration
- [x] Sync all recruitment stage transitions to CRM Kanban (Cal.com webhook, payment webhook, admin updateStage, application submission)
- [x] Pull abandoned sign-ups into CRM Kanban as prospect cards
- [x] Update CRM Kanban UI: add Won and Waitlisted columns, update stage colours
- [x] Remove duplicate Recruitment Pipeline nav item and page
