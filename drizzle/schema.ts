...
export const commissionClaims = mysqlTable("commission_claims", {
  ...
  bookingCompleteConfirmed: boolean("bookingCompleteConfirmed").notNull().default(false),
  bookingCompleteConfirmedAt: timestamp("bookingCompleteConfirmedAt"),
  hasKeyTransferSupplier: boolean("hasKeyTransferSupplier").notNull().default(false),
  keyTransferSupplierDeclaredAt: timestamp("keyTransferSupplierDeclaredAt"),
